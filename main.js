...
const LANG = {
  el: {
    ...
    sw_desc:'Λογισμικό <strong>αυτοματοποίησης</strong> τεχνικών μελετών για οχήματα <strong>ειδικής χρήσης και ειδικού σκοπού</strong>.',
    ...
    sw_d_lead:'Ισχυρό και εύχρηστο λογισμικό για την αυτοματοποίηση τεχνικών μελετών οχημάτων ειδικής χρήσης.<br>Από τους υπολογισμούς έως την πλήρη τεκμηρίωση, όλα ολοκληρώνονται ταχύτερα και με αξιοπιστία.',
  ...
  en: {
    ...
    sw_d_lead:'Powerful and user-friendly software for automating technical studies of special-use vehicles.<br>From calculations to full documentation, everything is completed faster and with reliability.',
