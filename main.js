...
const LANG = {
  el: {
    ...
    about_p3:'Βάση: <strong><span class="accent-red">Αθήνα</span></strong> &amp; <strong><span class="accent-red">Θεσσαλονίκη</span></strong> — δουλεύουμε σε Ελλάδα και εξωτερικό.',
    ...
    sw_d_kicker1:'Τι κάνει',
    sw_d_lead:'Ισχυρό και <strong>εύχρηστο λογισμικό</strong> για την <strong>αυτοματοποίηση</strong> τεχνικών μελετών οχημάτων <strong>ειδικής χρήσης</strong>. Από τους <strong>υπολογισμούς</strong> έως την πλήρη <strong>τεκμηρίωση</strong>, όλα ολοκληρώνονται <strong>ταχύτερα</strong> και με <strong>αξιοπιστία</strong>.',
    ...
    swpb_footnote:'<a href="contact.html" id="swpb-footnote-link">Επικοινωνήστε μαζί μας</a> για εξατομικευμένη προσφορά.',
  ...
  en: {
    ...
    sw_d_kicker1:'What it does',
    sw_d_lead:'Powerful and <strong>user-friendly software</strong> for <strong>automating</strong> technical studies of <strong>special-use vehicles</strong>. From <strong>calculations</strong> to full <strong>documentation</strong>, everything is completed <strong>faster</strong> and with <strong>reliability</strong>.',
    ...
    swpb_footnote:'<a href="contact.html" id="swpb-footnote-link">Contact us</a> for a tailored quote.',
...
function applyLang(lang) {
  ...
  set('sw-d-kicker1',t.sw_d_kicker1); set('sw-d-title',t.sw_d_title); set('sw-d-lead',t.sw_d_lead,true);
