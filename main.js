...
const LANG = {
  el: {
    ...
    qs_label:'Mechanical ExpertEase · easemanual.eu',
    qs_title:'Mechanical<br>ExpertEase',
    qs_desc:'Αυτοματοποιήστε τις Μελέτες Οχημάτων Ειδικής Χρήσης και Ειδικού Σκοπού',
    qs_f1:'Αυτόματοι υπολογισμοί', qs_f2:'Διαγράμματα & φορτίσεις', qs_f3:'Σχέδια Α3 PDF', qs_f4:'Τεχνική μελέτη Word',
    qs_f5:'Πλήρης οδηγός χρήσης', qs_f6:'Εκπαίδευση χρηστών', qs_f7:'Τεχνική υποστήριξη', qs_f8:'Ειδική χρήση & σκοπός',
  ...
  en: {
    ...
    qs_label:'Mechanical ExpertEase · easemanual.eu',
    qs_title:'Mechanical<br>ExpertEase',
    qs_desc:'Automate Special-Use and Special-Purpose Vehicle Studies',
    qs_f1:'Automatic calculations', qs_f2:'Diagrams & load charts', qs_f3:'A3 drawings PDF', qs_f4:'Word technical report',
    qs_f5:'Full user guide', qs_f6:'User training', qs_f7:'Technical support', qs_f8:'Special use & purpose',
